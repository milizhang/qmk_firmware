/* Copyright 2019 Yi (Mili) Zhang <milizhang@gmail.com>
...
// The original Sun Unix keyboard put Caps Lock on bottom left.
// This example layout rather implements HHKB style of layout by assuming the bottom left key does not exist.
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BL] = LAYOUT_tkl_unix(
        ...
        _______,  KC_LALT, KC_LGUI,                            KC_SPC,                             KC_RGUI, KC_RALT, KC_APP,  KC_RCTL,          KC_LEFT, KC_DOWN, KC_RGHT  \
    ),
    [_FL] = LAYOUT_tkl_unix(
